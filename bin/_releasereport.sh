...
function __releaseReport {
    ...
    reportName="ReleaseReport.csv"

    reportHeader="Repo Name, No, Number, Draft, Tag Name, Name, Target Commitish, User, Created At, Publshed At"
    reportData=''
    ...
    then
        ...
        __generateReleaseReport $_projectName
    fi
